package exercice6.Client;

import exercice6.Serveur.DataCS;
import exercice6.Serveur.DataSC;
...
import static exercice6.Client.ClientSocketOperations.*;
...
//        receiveDataServer(in, ihm);
    ...
    private void receiveScreenUpdatedFromServer() {
        ...
        if (getExecutionMode() == mode.STEP_BY_STEP) {
